                            ...
                            return (
                                <>
                                    <div className="card-items" key={item.service_title} onClick={() => { gotoServices(item) }} >
                                        <img src={item.img_name} alt="" key={item.service_title} style={{ width: "300px", height: "300px", borderRadius: "10px 10px 0 0", display: "grid" }} />
                ...
                <div style={{ margin: "5% 15%", display: "block" }}>
                    <div style={{ display: "flex" }}>
                        <div style={{ display: "flex", marginTop: "20px", marginRight: "160px" }}>
                            <div style={{ border: "3px solid #0e8201", width: "80px", height: "80px", borderRadius: "50%", marginRight: "10px" }}>
                                <img src={clock} alt="" width={"30px"} height={"30px"} style={{ position: "relative", left: "23px", top: "21px" }} />
                            </div>
                        ...
                        <div style={{ display: "flex", marginTop: "20px" }}>
                            <div style={{ border: "3px solid #0e8201", width: "80px", height: "80px", borderRadius: "50%", marginRight: "10px" }}>
                                <img src={thumb_up_finger} alt="" width={"30px"} height={"30px"} style={{ position: "relative", left: "23px", top: "21px" }} />
                            </div>
                            <div className='font-family-class' style={{ margin: "auto 0" }}>
                    ...
                    <div style={{ display: "flex" }}>
                        <div style={{ display: "flex", marginTop: "20px", marginRight: "40px" }}>
                            <div style={{ border: "3px solid #0e8201", width: "80px", height: "80px", borderRadius: "50%", marginRight: "10px" }}>
                                <img src={Indian_rupee_logo}  alt="" width={"30px"} height={"30px"} style={{ position: "relative", left: "23px", top: "21px" }} />
                            </div>
                            <div className='font-family-class' style={{ margin: "auto 0" }}>
